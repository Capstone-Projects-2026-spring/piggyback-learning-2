...
1. COPPA Compliance: The app must comply with the Children's Online Privacy Protection Act (COPPA). Specifically:
 - No raw voice audio shall be stored permanently on servers.
- Eye-tracking data processing must be local.
2. GDPR-K: The app must comly to GDPR-K (General Data Protection Regulation for children), requiring consent from the parent for data processing.
